      ...
      >
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 p-4 flex-shrink-0">
          <Button
            ...
            variant="ghost"
            className="w-full justify-start text-gray-500 hover:text-red-600 hover:bg-red-50 dark:text-gray-400 dark:hover:text-red-400 dark:hover:bg-red-950/20 text-sm font-medium"
          >
