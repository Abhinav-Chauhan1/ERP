  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        <Link href="/parent/meetings/upcoming" className="text-sm text-primary hover:underline">
          View All
        </Link>
      </CardHeader>
      <CardContent>
          ...
          <div className="space-y-4">
            {meetings.map((meeting) => (
              <div key={meeting.id} className="flex gap-3 border-b pb-3 last:border-0 last:pb-0">
                <div className="bg-primary/10 rounded-md h-12 w-12 flex flex-col items-center justify-center text-primary">
