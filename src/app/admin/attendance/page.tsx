...
// ---------------------------------------------------------------------------
// Section components — each fetches only what it needs
// ---------------------------------------------------------------------------

async function AttendanceOverviewCards() {
  const overviewResult = await getAttendanceOverview();
...
async function AttendanceChartsSection() {
  const [trendResult, classByResult] = await Promise.all([
    getWeeklyAttendanceTrend(),
    getAttendanceByClass(),
  ]);
...
async function AttendanceRecentAbsences() {
  const absencesResult = await getRecentAbsences(10);
...
export default function AttendancePage() {
  return (
    <div className="flex flex-col gap-4">
      ...
      >
        <AttendanceRecentAbsences />
      </Suspense>

      {/* Static quick-action cards — no data needed */}
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mt-4">
        <Card className="bg-primary/10">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-primary">Quick Attendance Report</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-teal-50">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-teal-800">Teacher Attendance</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex flex-col gap-2">
