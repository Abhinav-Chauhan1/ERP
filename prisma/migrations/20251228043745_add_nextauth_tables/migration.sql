...
ALTER TYPE "AuditAction" ADD VALUE 'REUPLOAD';
ALTER TYPE "AuditAction" ADD VALUE 'ADD_NOTE';
ALTER TYPE "AuditAction" ADD VALUE 'DELETE_NOTE';
ALTER TYPE "AuditAction" ADD VALUE 'BULK_VERIFY';
ALTER TYPE "AuditAction" ADD VALUE 'BULK_REJECT';
